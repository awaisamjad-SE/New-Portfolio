...
# [<img src="readme-assets/logo.png"> React Portfolio](https://awaisamjad-SE.github.io/react-portfolio-template/) by Ryan Balieiro
...
## [Live Preview](https://awaisamjad-SE.github.io/react-portfolio-template/)

Check out the live version of the template deployed **[here on GitHub Pages](https://awaisamjad-SE.github.io/react-portfolio-template/)**.
...
1. Clone the repo:
```
git clone https://github.com/awaisamjad-SE/react-portfolio-template
```
...
In simple terms, if you consider GitHub hosting the GitHub Pages site for this repo at the URL `https://awaisamjad-SE.github.io/react-portfolio-template/`, the correct base directory to set is `/react-portfolio-template/`.
...
This template was created by and is maintained by **[Ryan Balieiro](https://awaisamjad-SE.com/)**.
